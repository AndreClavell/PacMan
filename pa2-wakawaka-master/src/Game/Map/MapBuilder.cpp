    ...
    for (int i = 0; i < mapImage.getWidth(); i++) {
        for (int j = 0; j < mapImage.getHeight(); j++) {
            ...
            if(currentPixel == boundBlock){
                ...
                Player* PacMan = new Player(xPos,yPos,pixelMultiplier,pixelMultiplier,health,entityManager);
                ...
                GhostSpawner* ghost = new GhostSpawner(xPos,yPos,pixelMultiplier,pixelMultiplier, entityManager, color);
                mapInCreation->setGhost(ghost);
